...
target "AWSAppSync" do
  pod "AWSCore", :git => 'https://github.com/bingosabi/aws-sdk-ios.git', :branch => 'mac_catalyst_support'
...
target "AWSAppSyncTestCommon" do
  pod "AWSS3", :git => 'https://github.com/bingosabi/aws-sdk-ios.git', :branch => 'mac_catalyst_support'
  pod "ReachabilitySwift", "~> 5.0.0"
...
target "AWSAppSyncTestApp" do
  pod "AWSS3", :git => 'https://github.com/bingosabi/aws-sdk-ios.git', :branch => 'mac_catalyst_support'
  pod "AWSMobileClient", :git => 'https://github.com/bingosabi/aws-sdk-ios.git', :branch => 'mac_catalyst_support'
end
